...
class JsonUGGenerator {

    def generate(String text, String topLevelName, String dateFormat, String rootFolder) {
    ...
    static Object generateClass(object, file, dateFormat, name, String rootFolder) {
        ...
        file.append("\n}") //end of a class
        println "++++++++++++++++++++++++++++++++++++++"
        println("Created class " + name.capitalize())
        println "++++++++++++++++++++++++++++++++++++++"
